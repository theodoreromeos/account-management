...
class RegistrationFlowIT extends BasePostgresTest {
    ...
    private static final String EXISTING_EMAIL = "FrankDrebin@mobilitymail.com";
    private static final String EXISTING_MOBILE = "69787686";
    private static final String EXISTING_NAME = "Frank";
    private static final String EXISTING_SURNAME = "Drebin";
    ...
    void initClient() {
        ...
        testDataFeeder.feedUserProfile();
    ...
    class RegisterNewSimpleUserTests {
        ...
        void givenExistingUserData_whenRegisteringNewSimpleUser_thenExistingUserIsReturnedAndNoDuplicateCreated() {
            ...
            var request = createCreateNewSimpleUserRequestDto(EXISTING_EMAIL, EXISTING_MOBILE, EXISTING_NAME, EXISTING_SURNAME);
            ...
            client.post().uri("/register/user/simple")
                    ...
                    .expectBody()
                    .jsonPath("$.email").isEqualTo(EXISTING_EMAIL)
                    .jsonPath("$.phoneNumber").isEqualTo(EXISTING_MOBILE);

            long count = AccountManagementTestUtils.countProfilesByEmailAndMobile(userProfileRepository, EXISTING_EMAIL, EXISTING_MOBILE);
