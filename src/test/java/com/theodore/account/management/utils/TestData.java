...
public class TestData {
    ...
    public static final String EXISTING_SURNAME = "Drebin";

    public static final String ORG_NAME = "Toyota";
    public static final String ORG_REG_NUMBER = "TEST-12345";

    public static final String NEW_EMAIL = "secondbreakfast@mobilitymail.com";
    public static final String NEW_MOBILE = "691987655";
